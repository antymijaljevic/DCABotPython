...
# variables to be set up manually by user needs
Conversion_1 = 'ADA/BUSD' # put here you conversion pair 1
Conversion_2 = 'ETH/USDT' # put here you conversion pair 2
...
def sendSheetReport(sheetNum, reportNum, p_1, p_2, p_3, p_4=None, p_5=None, p_6=None):
    ...
    sheetReports =[
        ...
        [p_1[:19], p_2, p_3, p_4, p_5, p_6] # buying order conversion pair
    ]
    #append as new row
...
def walletBalance():
    ...
    # total balance (of every ticker that exist)
...
def dipAlert():
    now = str(datetime.now())
    pairOneInfo = exchange.fetch_ticker(Conversion_1)
    pairTwoInfo = exchange.fetch_ticker(Conversion_2)
